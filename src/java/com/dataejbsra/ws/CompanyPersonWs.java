...
public class CompanyPersonWs {
    ...
    public ROb<CompanyPerson> findByCompaniesPersons(@WebParam(name = "personCedule") Long personCedule, @WebParam(name = "companyId") Long companyId) {
        return ejbRef.findByCompaniesPersons(personCedule, companyId);
    }

    @WebMethod(operationName = "validateRelation")
    public ROb<CompanyPerson> validateRelation(@WebParam(name = "personCedule") Long personCedule, @WebParam(name = "companyId") Long companyId, @WebParam(name = "personPassword") String personPassword) {
        return ejbRef.validateRelation(personCedule, companyId, personPassword);
    }

    @WebMethod(operationName = "registerRelation")
    public ROb<CompanyPerson> registerRelation(@WebParam(name = "personCedule") Long personCedule, @WebParam(name = "companyId") Long companyId, @WebParam(name = "rolPerson") String rolPerson, @WebParam(name = "passwordCompany") String passwordCompany) {
        return ejbRef.registerRelation(personCedule, companyId, rolPerson, passwordCompany);
    }

    @WebMethod(operationName = "removeRelation")
    public ROb<CompanyPerson> removeRelation(@WebParam(name = "personCedule") Long personCedule, @WebParam(name = "companyId") Long companyId, @WebParam(name = "passwordCompany") String passwordCompany) {
